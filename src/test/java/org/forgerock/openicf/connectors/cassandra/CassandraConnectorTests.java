...
/**
 * Attempts to test the {@link CassandraConnector} with the framework.
 *
 */
public class CassandraConnectorTests {

    /**
    * Setup logging for the {@link CassandraConnectorTests}.
    */
    private static final Log logger = Log.getLog(CassandraConnectorTests.class);
    ...
    */
    private static final PropertyBag PROPERTIES = TestHelpers.getProperties(CassandraConnector.class);
    ...
    public void setUp() {
        ...
        //Configuration config = new CassandraConfiguration();
    ...
    public void createTest() {
        ...
        final ConnectorFacade facade = getFacade(CassandraConnector.class, null);
    ...
    protected ConnectorFacade getFacade(CassandraConfiguration config) {
        ConnectorFacadeFactory factory = ConnectorFacadeFactory.getInstance();
        // **test only**
        APIConfiguration impl = TestHelpers.createTestConfiguration(CassandraConnector.class, config);

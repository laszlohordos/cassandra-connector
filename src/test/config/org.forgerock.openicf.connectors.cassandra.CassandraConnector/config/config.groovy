...
import org.forgerock.openicf.connectors.cassandra.CassandraConnector
...
configuration {
    ...
    scriptRoots = [URLDecoder.decode(CassandraConnector.class.getResource("/").file, "UTF-8")]
    contactPoints = "_configureme_"
    username = "_configureme_"
    password = new GuardedString("_configureme_".toCharArray())
